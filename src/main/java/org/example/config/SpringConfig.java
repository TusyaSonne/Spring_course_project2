...
public class SpringConfig implements WebMvcConfigurer {
    ...
    private final Environment environment; //environment для использования значений
...
//    }
    ...
    //Вместо session factory от Hibernate при работе с JPA нужно использовать entity manager factory (стандарт всех JPA)
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        //Указание того что entity manager factory предоставляется hibernate-ом
